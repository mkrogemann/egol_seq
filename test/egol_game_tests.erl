...
init_from_list_test() ->
    ExpectedGrid = dict:from_list([
            {{1,1},1},{{2,1},0},{{3,1},0},
            {{1,2},1},{{2,2},1},{{3,2},0}]),

    {ActualGrid, Width, Height} = egol_game:init_from_list([
            {{1,1},1},{{2,1},0},{{3,1},0},
            {{1,2},1},{{2,2},1},{{3,2},0}]),
...
evolve_test() ->
    Board = egol_game:init_from_list([
...
%%----------------------------------------------------------------------------
evolve_glider_test() ->
    FirstGeneration = egol_game:init_from_list([
    ...
    ExpectedFourthGrid = dict:from_list([
            {{1,1},0}, {{2,1},0}, {{3,1},0}, {{4,1},0}, {{5,1},0},
    ...
    ExpectedFifthGrid = dict:from_list([
            {{1,1},0}, {{2,1},0}, {{3,1},0}, {{4,1},0}, {{5,1},0},
            {{1,2},0}, {{2,2},0}, {{3,2},0}, {{4,2},0}, {{5,2},0},
            {{1,3},0}, {{2,3},0}, {{3,3},0}, {{4,3},1}, {{5,3},0},
