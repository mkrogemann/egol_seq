...
init_from_list_test() ->
  ...
  {ActualGrid, Width, Height} =
              egol_game:init_from_list([ {{1,1},1},{{2,1},0},{{3,1},0},
                          {{1,2},1},{{2,2},1},{{3,2},0} ]),
...
evolve_test() ->
  Board = egol_game:init_from_list([ {{1,1},1}, {{2,1},0}, {{3,1},1}, {{4,1},0},
...
%%----------------------------------------------------------------------------
evolve_glider_test() ->
  FirstGeneration = egol_game:init_from_list([ {{1,1},0}, {{2,1},0}, {{3,1},0}, {{4,1},0}, {{5,1},0},
...
%%----------------------------------------------------------------------------
evolve_beehive_test() ->
  FirstGeneration = egol_game:init_from_list([ {{1,1},0}, {{2,1},0}, {{3,1},0}, {{4,1},0}, {{5,1},0}, {{6,1},0},
...
state_test() ->
  Board = egol_game:init_from_list([{{1,1},1},{{2,1},0},{{1,2},0},{{2,2},1}]),
